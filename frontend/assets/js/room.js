...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function pushNow() {
    ...
    CF.api('../backend/api/rooms/push.php', {
  ...
  chatForm.addEventListener('submit', function (e) {
    ...
    if (!body) return;
    chatInput.value = '';
    CF.api('../backend/api/rooms/chat.php', { body: { code: code, body: body } })
  ...
  function startPolling(reason) {
    ...
    pollTimer = setInterval(function () {
      CF.api('../backend/api/rooms/state.php?code=' + encodeURIComponent(code))
        .then(applySnapshot)
        .catch(function () {});
    }, 2500);
  }
  ...
  function connect() {
    ...
    es = new EventSource('../backend/api/rooms/stream.php?code=' + encodeURIComponent(code) + '&_=' + Date.now());
  ...
  setInterval(function () {
    CF.api('../backend/api/rooms/heartbeat.php', { body: { code: code } }).catch(function () {});
  }, 5000);
  ...
  window.addEventListener('beforeunload', function () {
    try {
      ...
      navigator.sendBeacon('../backend/api/rooms/leave.php', f);
    } catch (e) {}
  });
});
