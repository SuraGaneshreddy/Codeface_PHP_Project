...
CREATE TABLE hackathon_participants (
  ...
  CONSTRAINT fk_hp_hack FOREIGN KEY (hackathon_id) REFERENCES hackathons(id) ON DELETE CASCADE,
...
CREATE TABLE hackathon_problems (
  ...
  CONSTRAINT fk_hprob_hack FOREIGN KEY (hackathon_id) REFERENCES hackathons(id) ON DELETE CASCADE,
  CONSTRAINT fk_hprob_prob FOREIGN KEY (problem_id)   REFERENCES problems(id)   ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
