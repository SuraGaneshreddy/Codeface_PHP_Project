...
$stats = [
    'problems'    => (int)(db_one('SELECT COUNT(*) AS c FROM problems')['c'] ?? 0),
  ...
  <div class="container hero-grid">
    <div class="hero-copy">
      ...
      <p class="lede">
        ...
        feedback, live pair-programming rooms, and hackathons that keep you honest.
      </p>
      <div class="hero-cta">
...
<section class="container pillars">
  ...
  <div class="pillar card">
    <div class="pillar-icon">🏁</div>
    <h3>Compete</h3>
    <p>Hackathons, a points leaderboard, and skill-based matchmaking for when you want stakes with your reps.</p>
    <a href="hackathons.php" class="card-link">Join an event →</a>
  </div>
</section>
