...
<div class="container">
  <div class="page-head">
    <div>
      ...
      <p class="page-sub">
        <?= $totalLessons ?> bite-size lessons across <?= count(cf_learn_tracks_meta()) ?> tracks — every one taught through
        real-world scenarios (carts, logs, expense reports), never foo/bar. JavaScript &amp; Python lessons run right in the page.
      </p>
    </div>
  </div>
